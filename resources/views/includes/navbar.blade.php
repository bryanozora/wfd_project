<nav class="flex items-center sticky justify-between p-3 py-6 lg:px-8 bg-gray-700" aria-label="Global">
    ...
    <div class="hidden lg:flex lg:gap-x-12">
        <a href="/" class="text-xl font-raleway font-bold leading-6 text-green-400 dark:text-gray-100">Album List</a>
        
        @can('user')
        <a href="/history" class="text-xl font-raleway font-bold leading-6 text-green-400 dark:text-gray-100">History</a>
        @endcan
